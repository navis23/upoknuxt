        ...
        <div class="flex gap-x-2 h-18 items-center rounded-lg bg-gray-800">
            <div class="w-52 flex justify-center items-center">
                <button @click="searchData(1, totalData, searchField)" class="flex gap-x-2 items-center py-5 px-6 text-gray-200 border-r-4 border-stone-50 hover:text-sky-600 relative group">
                    ...
                    <span class="text-sm font-medium">Cari Supplier</span>
                    ...
                    <tr v-for="(item, index) in suppliers" :key="index" class="border-b">
                        ...
                        <td class="p-4 whitespace-nowrap text-center">
                            <div class="flex gap-x-2 justify-center">
                                ...
                                <!-- delete dimatikan karena berpengaruh pada table transaksi n histori -->
                ...
                <HeadlessDialogPanel class="w-full max-w-md px-12 py-8 rounded-lg bg-white text-gray-700">
                    <HeadlessDialogTitle class="pb-3">
                        ...
                        <div class="flex gap-x-4 justify-end border-t-2 pt-4 mt-3">
                            ...
                            <TButton class="gray" @click="cancelDataSupplier()">
                            ...
                            <TButton v-if="!btnEdit" @click="saveDataSupplier()">
                            ...
                            <TButton v-if="btnEdit" @click="saveEditSupplier()">
                                <Icon name="carbon:save" size="24" />
                                <span class="text-sm font-semibold tracking-wide ">
                                    Edit
                                </span>
                ...
                <HeadlessDialogPanel class="w-full max-w-md px-12 py-8 rounded-lg bg-stone-100 text-gray-700">
                    <HeadlessDialogTitle class="pb-3">
                        ...
                        <div class="flex gap-x-2 justify-end border-t-2 pt-4 mt-6">
                            ...
                            <TButton class="danger" @click="saveDeleteSupplier()">
                                <Icon name="carbon:trash-can" size="24" />
                                <span class="text-sm font-semibold tracking-wide ">
                                    Hapus
                                </span>
...
<script setup lang="ts">
    ...
    const clickPage = async (page : any, optionPages : any, search : any) => {
        await axios.post( `${urlHostApi}bengkel-api/api/supplier/daftar?page=${page}&limit=${optionPages}&search=${search}`, {}, {
        headers: {
                "Content-Type": "multipart/form-data",
                "Access-Control-Allow-Origin": "*"
        }
    ...
    const cancelDataSupplier = ( async () => {
        await fecthSupplier()
        loadingOverlay.value = true
        errMsg.value = "focus"
        setTimeout( () => {
    ...
    //insert
    const saveDataSupplier = ( async () => {
        loadingOverlay.value = true
        await axios.post(`${urlHostApi}bengkel-api/api/supplier/simpan`, {
            nama_supplier : nama_supplier.value,
            nomor_supplier : nomor_supplier.value,
            alamat_supplier : alamat_supplier.value
        }, {
            headers: {
                    "Content-Type": "multipart/form-data",
                    "Access-Control-Allow-Origin": "*"
    ...
    const openModalEdit = ((item : any) => {
        ...
        nomor_supplier.value = item.nomor_supplier
        alamat_supplier.value = item.alamat_supplier
        setTimeout(() => {loadingOverlay.value = false, isOpenAdd.value = true}, 300)
    })

    const saveEditSupplier = ( async () => {
        loadingOverlay.value = true
        await axios.post(`${urlHostApi}bengkel-api/api/supplier/update`, {
            id : id_supplier.value,
            nama_supplier : nama_supplier.value,
            nomor_supplier : nomor_supplier.value,
            alamat_supplier : alamat_supplier.value
        }, {
    ...
    const saveDeleteSupplier = ( async () => {
        loadingOverlay.value = true
        await axios.post(`${urlHostApi}bengkel-api/api/supplier/hapus`, {
            id : id_supplier.value
        }, {
        headers: {
                "Content-Type": "multipart/form-data",
